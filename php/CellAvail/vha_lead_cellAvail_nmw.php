...
$file_out = 'vhaLeadCellsAvailNMW.json';
...
$sql = "select to_char(RESULT_TIME, 'yyyy-mm-dd') RECORD_TIME, UNAVAIL_HR OUTAGE, CELL_AVAIL AVAIL_RATE, 99.7 AS TARGET_RATE from MPT_JV_VHALEAD_D_NMW_V";
