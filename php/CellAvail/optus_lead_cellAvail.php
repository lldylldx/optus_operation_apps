...
$file_out = 'optusLeadCellsAvail.json';
...
$sql = "select to_char(RESULT_TIME, 'yyyy-mm-dd') RECORD_TIME, UNAVAIL_HR OUTAGE, CELL_AVAIL AVAIL_RATE, 99.7 AS TARGET_RATE from MPT_CELLAVAIL_JV_OPTUSLEAD_D_V";
