...
$file_out = 'tor3GCellAvailNMW.json';
...
$sql = "select to_char(RESULT_TIME, 'yyyy-mm-dd') RECORD_TIME, UNAVAIL_HR OUTAGE, CELL_AVAIL AVAIL_RATE, 99.2 AS TARGET_RATE from MPT_CELLAVAIL_3GTOR_D_NMW_V";
