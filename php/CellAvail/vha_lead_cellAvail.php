...
$file_out = 'vhaLeadCellsAvail.json';
...
$sql = "select to_char(RESULT_TIME, 'yyyy-mm-dd') RECORD_TIME, UNAVAIL_HR OUTAGE, CELL_AVAIL AVAIL_RATE, 99.7 AS TARGET_RATE from MPT_CELLAVAIL_JV_VODALEAD_D_V";
