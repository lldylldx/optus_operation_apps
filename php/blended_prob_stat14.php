...
$file_out = 'blended_prob_stat14.json';
...
$sql = "select to_char(DATE_TIME, 'yyyy-mm-dd') DATE_TIME, NSN, HUAWEI, U9 NSN_U9 from MPT_R_BLEND_PROBLEM_D where DATE_TIME >= sysdate -15";
