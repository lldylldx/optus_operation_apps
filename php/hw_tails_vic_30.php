...
//$sql = "select to_char(date_time,'yyyy-mm-dd') date_time,hs,rrc,dcr,rab,total from MPT_HW_TAILS_VIC_half_Y_V";
$sql = "select to_char(date_time,'yyyy-mm-dd') date_time,hs,rrc,dcr,rab,total from MPT_HW_TAILS_VIC_30_V";
