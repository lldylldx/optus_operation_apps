...
$sql = "
select to_char(a.RECORD_TIME,'yyyymmdd hh24') as \"TIME\",CELL_NAME,TRIG_REASON,TRIG_VAL,PRIM_REASON PRIMARY_REASON,PRIM_VAL PRIMARY_VAL,SEC_REASON SECONDARY_REASON,SEC_VAL SECONDARY_VAL,STATE 
from MPT_LTE_TAILS_H a, MPT_LTE_NSN_H_MAXTIME_V b 
