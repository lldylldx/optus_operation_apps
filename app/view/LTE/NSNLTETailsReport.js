...
Ext.define('MPT.view.LTE.NSNLTETailsReport', {
	//extend: 'Ext.grid.Panel',
	extend: 'Ext.ux.LiveSearchGridPanel',
	alias: 'widget.nsnLteTailsReport',
	//require: '',
	title: 'NSN LTE Daily Tail Cells Report',
	//uses: [],
	layout: 'fit',	
	loadMask: true,
	store: 'MPT.store.LTE.NSNLTETailsReport',
	dockedItems: [{
		dock: 'top',
		xtype: 'toolbar',
		items: [{
			text: 'Refresh',
			handler: function(){
				Ext.getStore('MPT.store.LTE.NSNLTETailsReport').load();
			}
			},{
			text: 'Download',
			handler: function(){
				window.open("http://slagnpappl001.optus.com.au/datawarehouse/nsn_lte_tails_d", "_blank");	
			}			
		}]
	}],
	viewConfig: {
