...
Ext.define('MPT.view.LTE.NSNLteTailCellHourlyGrid', {
	//extend: 'Ext.grid.Panel',
	extend: 'Ext.ux.LiveSearchGridPanel',
	alias: 'widget.nsnLteTailCellHourlyGrid',
	title: 'NSN LTE Hourly Tail Cells list',
	layout: 'fit',	
	loadMask: true,
	store: 'MPT.store.LTE.NSNLteTailCellsHourly',
	dockedItems: [{
		dock: 'top',
		xtype: 'toolbar',
		items: [{
			text: 'Refresh',
			handler: function(){
				Ext.getStore('MPT.store.LTE.NSNLteTailCellsHourly').load();
			}			
		}]
	}],
	viewConfig: {
	...
	columns: [
		...
		{ header: 'TIME', dataIndex: 'TIME', flex:1 , filter:{}, renderer: Ext.util.Format.dateRenderer('m/d/Y H:i') },
