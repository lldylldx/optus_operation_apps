...
Ext.define('MPT.view.SleepingCells.NSN3GSleepingCellsGrid', {
	//extend: 'Ext.grid.Panel',
	extend: 'Ext.ux.LiveSearchGridPanel',
	alias: 'widget.nsn3GSleepingCellsGrid',
	//require: '',
	title: 'NSN 3G Sleeping Cells list (the last 4 hours)',
	//uses: [],
	layout: 'fit',	
	loadMask: true,
	store: 'MPT.store.SleepingCells.NSN3GSleepingCells',
	viewConfig: {
		stripeRows: true,
	...
	columns: [
		...
		{ header: 'RC', dataIndex: 'RC', flex:1 , filter:{type:'list', store: store_RC}},
	...
	initComponent: function() {
		Ext.getStore('MPT.store.SleepingCells.NSN3GSleepingCells').load();		
